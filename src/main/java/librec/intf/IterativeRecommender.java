...
public abstract class IterativeRecommender extends Recommender {
	...
	public IterativeRecommender(SparseMatrix trainMatrix, SparseMatrix testMatrix, int fold) {
		...
		if (resetStatics) {
			...
			numFactors = cf.getNumMaxIter() != null? cf.getNumMaxIter():100;
		}
	...
	/**
	 * Update current learning rate after each epoch <main.java.ufba.br/>
	 * 
	 * <ol>
	...
	protected void initModel() throws Exception {
		...
		// initialize main.java.br.ufba.model
		if (initByNorm) {
	...
	protected void loadModel() throws Exception {
		...
		Logs.debug("A recommender main.java.br.ufba.model is loaded from {}", dirPath);
