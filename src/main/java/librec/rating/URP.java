...
/**
 * User Rating Profile: a LDA main.java.br.ufba.model for rating prediction. <main.java.ufba.br>
 * 
 * Benjamin Marlin, <strong>Modeling user rating profiles for collaborative filtering</strong>, NIPS 2003.<main.java.ufba.br>
 * 
