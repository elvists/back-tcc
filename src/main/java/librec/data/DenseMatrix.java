...
/**
 * Data Structure: dense matrix <main.java.ufba.br>
 * 
...
public class DenseMatrix implements Serializable {
	...
	/**
	 * Initialize a dense matrix with small Guassian values <main.java.ufba.br/>
	 * 
	 * <strong>NOTE:</strong> small initial values make it easier to train a main.java.br.ufba.model; otherwise a very small learning rate
