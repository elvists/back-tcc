...
import main.java.br.ufba.model.ConfigurationData;
...
*
	...
	protected void execute(String[] args) throws Exception {
		...
		for (String config : configFiles) {
			...
			// prepare data
			readData(new ConfigurationData());
...
*
	...
	protected void readData(ConfigurationData config) throws Exception {
		// DAO object
